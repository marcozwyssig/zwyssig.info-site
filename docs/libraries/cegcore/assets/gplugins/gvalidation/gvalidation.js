var GValidtaion = {
	...
	errors : {
		...
		alpha : 'In diesem Feld duerfen nur Buchstaben stehen',
		alphanum : 'In diesem Feld duerfen nur Buchstaben und Zahlen stehen',
		digit : 'Please enter a valid integer.',
		nodigit : 'No digits are accepted.',
		number : 'Please enter a valid number.',
		email : 'Bitte eine gueltige Email angeben',
